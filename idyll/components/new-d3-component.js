...
class NewD3Component extends D3Component {
  initialize(node, props) {
    ...
    var links = [
              { source: 0, target: 1, capacity: 9, id: 0, flow: 0},
              { source: 0, target: 3, capacity: 11, id: 1, flow: 0},
              { source: 1, target: 2, capacity: 8, id: 2, flow: 0},
              { source: 1, target: 3, capacity: 5, id: 3, flow: 0},
              { source: 2, target: 5, capacity: 9, id: 4, flow: 0},
              { source: 3, target: 4, capacity: 9, id: 5, flow: 0},
              { source: 4, target: 2, capacity: 9, id: 6, flow: 0},
              { source: 4, target: 5, capacity: 8, id: 7, flow: 0},
    ];

    var cuts = [
    {x1: .25,  y1: .2, x2: .25, y2: .8, id: 0, text: 20, max: 20},
    {x1: .15,  y1: .3, x2: .55, y2: .75, id: 1, text: 23, max: 20},
    {x1: .5,  y1: .2, x2: .5, y2: .8, id: 2, text: 17, max: 17},
    {x1: .45,  y1: .3, x2: .85, y2: .65, id: 3, text: 25, max: 17},
    {x1: .8,  y1: .2, x2: .8, y2: .8, id: 4, text: 17, max: 17}
    ];
    ...
    .attr("transform", "translate(115,-35) rotate(25)")
    ...
    .attr("transform", "translate(115,-155) rotate(25)")
    ...
    .attr("transform", "translate(-100,195) rotate(-25)")
